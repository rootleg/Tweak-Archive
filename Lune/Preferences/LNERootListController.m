...
- (void)viewDidLoad {
    ...
    [[self enableSwitch] setOnTintColor:[UIColor colorWithRed:0.60 green:0.96 blue:1 alpha:1]];
    ...
    [[self iconView] setImage:[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/LunePreferences.bundle/icon.png"]];
    ...
    [[self headerImageView] setImage:[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/LunePreferences.bundle/Banner.png"]];
    ...
    if ([[NSFileManager defaultManager] fileExistsAtPath:@"/Library/MobileSubstrate/DynamicLibraries/Lune.disabled"]) {
        ...
        UIAlertController* alertController = [UIAlertController alertControllerWithTitle:@"Lune" message:@"Lune has detected that you have DayNightSwitch installed, which causes issues with Lune's preferences\n\n To continue, please disable DayNightSwitch with iCleaner Pro or uninstall it temporarily" preferredStyle:UIAlertControllerStyleAlert];
