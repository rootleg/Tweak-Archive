#import "SAWContributorsSubPreferencesListController.h"

@implementation SAWContributorsSubPreferencesListController
...
- (void)loadFromSpecifier:(PSSpecifier *)specifier {
    ...
    NSString* sub = [specifier propertyForKey:@"SAWSub"];
