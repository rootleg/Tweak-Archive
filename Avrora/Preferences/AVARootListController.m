...
- (void)viewDidLoad {
    ...
    self.appearanceSettings = [AVAAppearanceSettings new];
    self.hb_appearanceSettings = [self appearanceSettings];


    self.preferences = [[HBPreferences alloc] initWithIdentifier:@"love.litten.avrorapreferences"];
    ...
    [[self iconView] setImage:[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/AvroraPreferences.bundle/icon.png"]];
    ...
    [[self headerImageView] setImage:[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/AvroraPreferences.bundle/Banner.png"]];
    ...
    if ([[NSFileManager defaultManager] fileExistsAtPath:@"/Library/MobileSubstrate/DynamicLibraries/Avrora.disabled"]) {
        ...
        UIAlertController* alertController = [UIAlertController alertControllerWithTitle:@"Avrora" message:@"Avrora has detected that you have disabled it with iCleaner Pro, here are some quick actions you can perform" preferredStyle:UIAlertControllerStyleAlert];
        ...
        UIAlertController* alertController = [UIAlertController alertControllerWithTitle:@"Avrora" message:@"Avrora has detected that you have DayNightSwitch installed, which causes issues with Avrora's preferences\n\n To continue, please disable DayNightSwitch with iCleaner Pro or uninstall it temporarily" preferredStyle:UIAlertControllerStyleAlert];
...
- (void)selectDateApp {
    ...
    SparkAppListTableViewController* dateController = [[SparkAppListTableViewController alloc] initWithIdentifier:@"love.litten.avrora.datepreferences" andKey:@"dateApps"];
...
- (void)selectClockApp {
    ...
    SparkAppListTableViewController* weatherController = [[SparkAppListTableViewController alloc] initWithIdentifier:@"love.litten.avrora.clockpreferences" andKey:@"clockApps"];
...
- (void)selectWeatherApp {
    ...
    SparkAppListTableViewController* weatherController = [[SparkAppListTableViewController alloc] initWithIdentifier:@"love.litten.avrora.weatherpreferences" andKey:@"weatherApps"];
...
- (void)selectNowPlayingApp {
    ...
    SparkAppListTableViewController* weatherController = [[SparkAppListTableViewController alloc] initWithIdentifier:@"love.litten.avrora.nowplayingpreferences" andKey:@"nowPlayingApps"];
...
- (void)resetPrompt {
    ...
    UIAlertController* resetAlert = [UIAlertController alertControllerWithTitle:@"Avrora" message:@"Do you really want to reset your preferences?" preferredStyle:UIAlertControllerStyleActionSheet];
...
- (void)respring {
    ...
    [UIView animateWithDuration:1 delay:0 options:UIViewAnimationOptionCurveEaseOut animations:^{
        ...
        if (![[NSFileManager defaultManager] fileExistsAtPath:@"/Library/MobileSubstrate/DynamicLibraries/shuffle.dylib"])
            ...
            [HBRespringController respringAndReturnTo:[NSURL URLWithString:@"prefs:root=Tweaks&path=Avrora"]];
    }];
