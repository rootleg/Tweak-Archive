#import "AVAContributorsSubPreferencesListController.h"

@implementation AVAContributorsSubPreferencesListController
...
- (void)loadFromSpecifier:(PSSpecifier *)specifier {
    ...
    NSString* sub = [specifier propertyForKey:@"AVASub"];
